...
```json
{
  ...
  "data": {
    ...
    "targetWord": "灵气",
    "remark": "修仙小说中修炼所需的能量",
    "createTime": "2026-03-04T11:00:00Z"
  },
  "code": "200"
}
```
...
**接口**: `GET /user/glossaries/{id}/terms`
...
- `systemStatus`: 系统状态（normal/maintenance）
