/**
 * Translation API Load Test with Forged JWT Tokens (1000 users)
 *
 * Usage:
 *   k6 run load-test/translate-forged-1000.js \
 *     -e API_BASE_URL=http://localhost:7341 \
 *     -e TOKENS_FILE=./forged-tokens-1000.txt
 */
...
const TOKENS_FILE = __ENV.TOKENS_FILE || './forged-tokens-1000.txt';
...
export function handleSummary(data) {
  ...
  return {
    [`load-test/results/translate-forged-1000-${now}.json`]: JSON.stringify(data, null, 2),
