...
public class ExternalTranslateController {
    ...
    public static class ExternalTranslateRequest {
        @jakarta.validation.constraints.NotBlank(message = "目标语言不能为空")
        private String targetLang;
        private String sourceLang;
        @jakarta.validation.constraints.NotBlank(message = "文本不能为空")
        private String text;
    ...
    public static class ExternalTranslateResponse {
    ...
    public static class ExternalBatchTranslateRequest {
        @jakarta.validation.constraints.NotBlank(message = "目标语言不能为空")
        private String targetLang;
        private String sourceLang;
        private String engine;
        private List<@jakarta.validation.constraints.NotBlank(message = "文本不能为空") String> texts;
